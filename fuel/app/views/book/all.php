...
<?php echo $pagination; ?>
<table border="1">
<caption style="text-align:left;"><br>全冊数：<?php echo $books_count; ?>冊</caption>
<tr style="background-color: lightgray;font-weight: bold;">
  <td width="120">積み日時</td>
  <td width="120">読書日時</td>
  <td width="200">書籍名</td>
  <td width="150">著者</td>
  <td width="400">大まかな内容</td>
  <td width="400">感想・レビュー</td>
  <td width="80">編集</td>
</tr>
<?php foreach($books as $book): ?>
<tr>
  <td><?php echo date('Y/m/d H:i', strtotime($book['set_dttm'])); ?></td>
  <td><?php echo (date('Y/m/d H:i', strtotime($book['read_dttm'])) == '-0001/11/30 00:00') ? '' : date('Y/m/d H:i', strtotime($book['read_dttm'])); ?></td>
  <td><?php echo $book['name']; ?></td>
  <td><?php echo $book['auther']; ?></td>
  <td><?php echo nl2br($book['contents']); ?></td>
  <td><?php echo nl2br($book['review']); ?></td>
